...
@pytest.fixture
def device(hass):
    return FrameDevice(hass, host="1.2.3.4", mac="02:00:00:00:00:01", token="tok")
...
async def test_setup_and_unload(hass, mock_device):
    entry = MockConfigEntry(
        domain=DOMAIN,
        data={CONF_HOST: "1.2.3.4", CONF_MAC: "02:00:00:00:00:01", CONF_TOKEN: "tok"},
...
async def test_user_flow_success(hass):
    with patch(
        ...
        new=AsyncMock(return_value={"mac": "02:00:00:00:00:01",
    ...
    assert result["data"]["mac"] == "02:00:00:00:00:01"
