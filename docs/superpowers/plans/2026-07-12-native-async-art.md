...
```bash
./.venv/bin/pytest tests/test_frame_art.py -q
```
...
```bash
./.venv/bin/pytest tests/test_frame_art.py -q -k 'artmode or brightness or color or select or delete or matte or favourite or slideshow'
```
...
```bash
./.venv/bin/pytest tests/test_frame_art.py -q -k thumbnail
```
...
```bash
./.venv/bin/pytest tests/test_frame_art.py tests/test_device.py -q
...
```bash
./.venv/bin/pytest tests/test_init.py tests/test_config_flow.py tests/test_coordinator.py -q
```
...
```bash
./.venv/bin/pytest tests/test_init.py tests/test_config_flow.py tests/test_coordinator.py tests/test_device.py tests/test_frame_art.py -q
git diff --check
```
